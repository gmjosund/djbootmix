<!-- Config -->
    <div id="tmplOtherConfigs" class="hide">
      <div id="config-form">
            ...
            <nav class="navbar navbar-expand-sm justify-content-center">
              <ul class="navbar-nav align-items-center">
                <li class="nav-item config-switcher-container">
                  <select class=" mr-md-2  keepEnabled config-dropdown header-select custom-select config-select" id="configDropdown" data-setting-type=""
                    name="" onmouseover="this.title = this.options[this.selectedIndex].value">
                  ...
                  <span class="active-config  other-configs" data-i18n="configSection.activeConfig"></span>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item ">
                  ...
                  <i id="new-config-file" class="fa fa-copy new-config-name new-config-el ml-3" aria-hidden="true" data-toggle="tooltip" data-placement="bottom"
                    data-i18n="[title]constantMsgs.newButton"></i>
      ...
      <div id="configurationContainer" class="row">
        <div class="col-12 configuration-heading-container text-center">
          <nav class="navbar navbar-expand-sm justify-content-center">
            <ul class="navbar-nav align-items-center">
              <li class="nav-item config-switcher-container" >
                <select class=" mr-md-2  keepEnabled config-dropdown header-select custom-select" id="configDropdown2" data-setting-type=""
                  name="">
                  <#list availableConfigs as configName>
                    <#assign isSelected = activeConfig == configName>
                    <option value="${configName}" <#if isSelected> selected="selected"</#if>>${configName}</option>
